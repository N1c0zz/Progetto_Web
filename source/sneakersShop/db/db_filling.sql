...
-- -----------------------------------------------------
INSERT INTO `prodotti` (`idprodotto`, `idutente`, `idcategoria`, `idmodello`, `taglia`, `dataInserimento`) 
VALUES 
(1, 1, 1, 1, 38, NOW()), -- Nike Air Max, taglia 38
(3, 1, 2, 2, 42, NOW()),  -- Timberland Classic, taglia 42
(2, 1, 2, 3, 42, NOW()),
(4, 2, 2, 4, 42, NOW()),
(5, 2, 2, 5, 42, NOW()),
(6, 2, 2, 6, 42, NOW()),
