...
document.querySelectorAll('a.letta, a.da_leggere').forEach(btn => {
    btn.addEventListener('click', async (e) => {
        if(btn.classList.contains('da_leggere')) {
            toggleStatus(btn, 'da_leggere', 'letta', 'bi-envelope-open', 'bi-envelope');
        } else {
            toggleStatus(btn, 'letta', 'da_leggere', 'bi-envelope', 'bi-envelope-open');
        }
        e.preventDefault();
    });
});