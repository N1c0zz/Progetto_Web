            ...
            <section>
                ...
                <form action="index.php?action=update-cart-item" method="POST" oninput="x.value=parseFloat(sizeRange.value)">
                    <fieldset>
                        ...
                        <input type="hidden" id="oldSize" name="oldSize" value="<?php echo $templateParams["cartItem"]["tagliaAggiunta"]; ?>" />
                        <input type="hidden" id="oldAmount" name="oldAmount" value="<?php echo $templateParams["cartItem"]["quantitàAggiunta"]; ?>" />
                        <input type="range" class="form-range" min="35" max="53" id="sizeRange" name="newSize"
                            value="<?php echo $templateParams["cartItem"]["tagliaAggiunta"]; ?>" />
