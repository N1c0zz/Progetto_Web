...
<section>
    <div class="container">
        <div class="checkout-container">
            <h1 class="text-start fw-semibold my-3">Checkout</h1>

            <section class="orders-table section-border mb-4">
                <h2 class="fs-4 mb-3 fw-semibold">Riepilogo ordine</h2>
            ...
            <section class="mb-4 section-border">
                <h2 class="fs-4 mb-3 fw-semibold">Informazioni di contatto</h2>
            ...
            <section class="mb-4 section-border">
                <h2 class="fs-4 mb-3 fw-semibold">Spedizione</h2>
            ...
            <section class="mb-4 section-border">
                <h2 class="fs-4 mb-3 fw-semibold">Pagamento</h2>
