            ...
            <div class="card mb-3">
                    <div class="card-header">
                        <div class="d-flex justify-content-end">
                            <form action="index.php?action=edit-cart-item" method="post">
                                <legend class="visually-hidden">informazioni per la modifica del prodotto</legend>
                                <fieldset>
                                    <label for="productId" class="visually-hidden">Cerca prodotto</label>
                                    <input type="hidden" id="productId" name="productId" value="<?php echo $item["idmodello"]; ?>" />
                                    <label for="size" class="visually-hidden">Cerca prodotto</label>
                                    <input type="hidden" id="size" name="size" value="<?php echo $item["tagliaAggiunta"]; ?>" />
                                    <label for="amount" class="visually-hidden">Cerca prodotto</label>
                                    <input type="hidden" id="amount" name="amount" value="<?php echo $item["quantitàAggiunta"]; ?>" />
                                </fieldset>
