                            ...
                            <div class="d-flex justify-content-end">
                                <form action="index.php?action=edit-cart-item" method="post">
                                    <fieldset>
                                        ...
                                        <input type="hidden" id="productId_<?php echo $item["idmodello"]; ?>" name="productId" value="<?php echo $item["idmodello"]; ?>" />
                                        <input type="hidden" id="size_<?php echo $item["idmodello"]; ?>" name="size" value="<?php echo $item["tagliaAggiunta"]; ?>" />
                                        <input type="hidden" id="amount_<?php echo $item["idmodello"]; ?>" name="amount" value="<?php echo $item["quantitàAggiunta"]; ?>" />
                                    </fieldset>
                        ...
                        <div class="col-4 col-md-3 mx-md-2">
                            ...
                            <div class="card-body ps-3 d-flex justify-content-between col-8">
                                <div class="d-flex flex-column justify-content-center">
                                    <h2 class="card-title mb-3 h6"><?php echo $item["modello"]; ?></h2>
