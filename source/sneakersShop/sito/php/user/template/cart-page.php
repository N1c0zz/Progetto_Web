...
<section id="logged-with-products">
                        ...
                        <div class="card-body ps-3 d-flex justify-content-between col-8">
                            ...
                            <div class="d-flex align-items-end justify-content-end flex-column">
                                <div class="d-flex justify-items-end flex-column">
                                    <p class="text-end m-0">Taglia: <?php echo $item["tagliaAggiunta"]; ?></p>
    ...
    <div id="logged-no-products" class="text-center">
        <p><?php echo $templateParams["noItemsFound"]; ?></p>
    </div>
    <?php endif; ?>
</section>