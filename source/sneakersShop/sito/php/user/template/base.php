...
<header class="bg-light py-2">
    <div class="container">
        <nav class="d-flex" aria-label="Navigazione principale">
            ...
            <a href="./login.php" class="bi bi-person-circle p-2 fs-3 icon" aria-label="Esegui il login o vai alla tua pagina personale"></a>
...
<main class="container overflow-auto py-3">
    <?php
        require($templateParams["nome"]); // import del template specificio
    ?>
</main>
