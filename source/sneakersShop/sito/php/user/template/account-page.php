<section>
    ...
    <div class="container">
        <div class="account-container">
            <h1 class="fw-semibold mt-5 mb-4">Il mio account</h1>

            <section class="mb-5 section-border">
                <h2 class="fs-4 mb-3 fw-semibold h4">Informazioni account</h2>
                <div class="mb-3">
            ...
            <section class="mb-4 section-border">
                <h2 class="fs-4 mb-3 fw-semibold h4">Modifica Password</h2>
            ...
            <?php if (isset($templateParams["showOrderList"]) && $templateParams["showOrderList"] == true): ?>
                <section class="orders-table section-border">
                    <h2 class="fs-4 mb-3 fw-semibold h4">I miei ordini</h2>
